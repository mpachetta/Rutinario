...
class MainWindow:
    def __init__(self, root):
        ...
        self.hygiene_button = tk.Button(self.root, text="Me baño", command=self.hygiene)
            ...
            "Me baño": [
                {
                    ...
                    "audio": "Sounds\put_on_shirt.mp3"
                },
                {
                    "text": "Put on pants",
                    "image": "Image\put_on_pants.png",
                    "audio": "Sounds\put_on_pants.mp3"
                },
                {
                    "text": "Put on shoes",
                    "image": "Image\put_on_shoes.png",
                    "audio": "Sounds\put_on_shoes.mp"
                }
            ],
            "Me voy a comer": [
                {
